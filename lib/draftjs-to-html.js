  ...
  */
  ...
  function getEntityMarkup(entityMap, entityKey, text, customEntityTransform) {
    ...
    if (entity.type === 'MENTION') {
      return "<a href=\"".concat(entity.data.url, "\" class=\"wysiwyg-mention\" data-mention data-value=\"").concat(entity.data.value, "\" data-id=\"").concat(entity.data.id || entity.data.value, "\">").concat(text, "</a>");
    }
